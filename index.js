        ...
        .get(url, res => {
            ...
            res.on("end", () => {
                ...
                try {
                    ...
                    let part1 = body.split("Below are the DNSSEC public keys for this domain:")[1]
                    let part2 = body.split("Below are the DNSSEC signatures for this domain:")[1]
                    if (part1 && part2) {
                        part1
                        ...
                        part2
                            ...
                            .forEach(txt => {
                                ...
                                data.dnssecSignatures.push({
                                    ...
                                    algorithm: _[1],
                                    signedBy: _[2],
                                    signature: _[3].split("<br></td></tr>")[0].replace(/<br>/gm, "\n")
                                })
